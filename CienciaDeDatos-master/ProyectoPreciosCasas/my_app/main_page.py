...
st.title('Estudiando la mejor opcion para tu nueva vivienda')
st.header('Propuesto por [Alejandra Sandoval](https://www.linkedin.com/in/yicethcarriazo/)')
...
# st.dataframe(data)
st.write('En este dashboard encontraras de una manera rápida y fácil la información derivada del estudio de la dinámica inmobiliaria en King Count, WA (USA). Los datos están disponibles [aquí](https://www.kaggle.com/datasets/harlfoxem/housesalesprediction) ')
